...
import (
	...
	"github.com/edurodrigues0/fundamentos-go.git/internal/store/pgstore"
...
const (
	...
	MessageKindReactionIncreased = "message_reaction_increased"
	MessageKindReactionDecreased = "message_reaction_decreased"
...
func (h apiHandler) handleSubscribe(w http.ResponseWriter, r *http.Request) {
	...
	slog.Info("New client conneted", "room_id", rawRoomID, "client_id", r.RemoteAddr)
...
func (h apiHandler) handleReactToMessage(w http.ResponseWriter, r *http.Request) {
	...
	go h.notifyClients(Message{
		Kind:   MessageKindReactionIncreased,
		RoomID: rawRoomID,
...
func (h apiHandler) handleRemoveReactFromMessage(w http.ResponseWriter, r *http.Request) {
	...
	go h.notifyClients(Message{
		Kind:   MessageKindReactionDecreased,
		RoomID: rawRoomID,
